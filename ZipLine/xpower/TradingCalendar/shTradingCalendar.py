...
def get_non_trading_days(start, end):
    ...
    # mid 获得周末日期，结果传入dates = list(weekends)可获得结果列表
    # mid [print(date) for date in dates[0:6]]可纵向打印结果
...
# mid 2)获得所有的交易日的pandas要求的Custom Business Day Object 
...
# mid 3)使用Custom Business Day Object生成交易日datetime序列
